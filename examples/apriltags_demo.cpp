...
double Demo::standardRad(double t) {
    if (t >= 0.) {
...
void Demo::wRo_to_euler(Eigen::Matrix3d const& wRo, double& yaw, double& pitch, double& roll) {
